  ...
  return(
    ...
    <div className='lg:h-screen'>
        ...
        <div   className='flex-col  lg:w-7/12  bg-main_grey xl:px-8' >
                <div className={['relative h-30vh w-full lg:h-90vh bg-main_grey flex items-end overflow-hidden object-cover'].join(' ')} >
                ...
                <div className={
                   ...
                   ' h-full flex items-center justify-center pt-8 pl-4 mr-8 capitalize 2xl:mx-5'
                    ...
                    <div className={
                        ...
                        <h1 className= 'text-4xl font-semibold leading-10 text-sweet_blue md:text-5xl lg:text-4md 2xl:text-6xl  '>
