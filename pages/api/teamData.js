export const data = [
  { 
    ...
    members : [
     { 
       image: '/img/Professor-Gambari.webp',
       ...
       link: '/our_team/professor_gambari'
     },
     {
       ...
       link: '/our_team/pjingram'
     },
     {
       image: '/img/ck aderanti.jfif',
 ...
 },
 {
   ...
   members : [
     {
       image: '/img/Ms brooke taspall.png',
     ...
     {
       image: '/img/Mr. Adewale Adegoke.png',
...
//    members: [
     ...
     {
       image: '/img/Ese Egerega.jfif',
       name : 'Ese Egerega',
       title : '',
       description: ''
     },
     {
       image: '/img/Raji Abdulgafar.jfif',
       name : 'Raji Abdulgafar',
       title : '',
       description: ''
     },
     {
       image: '/img/Shehu Awwal.jfif',
       name : 'Shehu Awwal',
       title : '',
       description: ''
     },
     {
       image: '/img/felix.jfif',
       name : 'Felix Larbi Aryeh',
       title : 'Research Fellow / Lecturer & Webmaster',
       description: ''
      //  (MSc, BSc, MIASTED, MGARNET, MUTAG) Computer Science and Engineering Department & ICTU University of Mines and Technology
       
     },
     {
       image: '/img/Tosin Akinsowon.jfif',
