...
export default function SatelliteAndRemoteSensingLab() {
  ...
  return(
    <>
      <Container fluid className={ styles.aboutUs_container } >
        <HeroBanner text={'Satellite And Remote Sensing Lab'} activeLink={'our lab'} backgroundImg={ backgroundImg } />

        <Container className={ styles.background_container }  >
          <div>
          <h1 className={ styles.background_header_main } >Satellite And Remote Sensing Lab</h1>
