  ...
  return(
    ...
    <div className="container w-full md:max-w-3xl mx-auto pt-20">
        <div className="w-full px-4 md:px-6 text-xl text-gray-800 leading-normal" style={{fontFamily: "Georgia,serif"}}>
            ...
            Technology Against Crime Africa, NGO prides itself as one of the top 10 NGO in the world tht has capabilities to setup platform to capture data and analytics  from the orbits.  Our Motto goes thus: <i> The best form of Defense is Intelligence: We make it Fly.
              </i>
              </p>
        </div>
              </div>
