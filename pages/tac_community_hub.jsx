...
const TacCommunityHub = () => {
  ...
  const backgroundImg = '/community/2.jpg'

  return(
    <>
      <HeroBanner text={'Tac Community Hub'} activeLink={'Tac Community Hub'} backgroundImg={ backgroundImg } />
      <div className='w-10/12 2xl:w-8/12 mx-auto font-semibold  ' >
        ...
        <div >
          ...
          <h2 className='text-sweet_blue font-semibold mb-12 text-5xl text-center'  >The Ideation</h2>
          <p> 
          <h2 className='text-sweet_blue font-semibold text-2xl  ' ><em>COMMUNITY ENGAGEMENT AND SOCIAL MEDIA</em></h2>
        ...
        <div >
          <h2 className='text-sweet_blue font-semibold text-2xl' ><em>PUBLICIZE INITIATIVE, DEVELOP TRUST AND MAINTAIN AN ONGOING RELATIONSHIP WITH THE COMMUNITY</em></h2>
          <p>
          ...
          <h2 className='text-sweet_blue font-semibold text-2xl' ><em>PROVIDE CREDIBLE INFORMATION IN REAL TIME</em></h2>
          <p>
